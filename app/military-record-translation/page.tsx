...
const page = DOCUMENT_PAGES.find((d) => d.slug === 'military-record')!;

const base = pageMetadata({
  title: page.metaTitle,
  description: page.metaDescription,
  absoluteTitle: true,
  path: '/military-record-translation',
});

export const metadata: Metadata = {
  ...base,
  alternates: { ...base.alternates, ...segmentAlternates('military-record-translation') },
};
