...
const page = DOCUMENT_PAGES.find((d) => d.slug === 'court-document')!;

const base = pageMetadata({
  title: page.metaTitle,
  description: page.metaDescription,
  absoluteTitle: true,
  path: '/court-document-translation',
});

export const metadata: Metadata = {
  ...base,
  alternates: { ...base.alternates, ...segmentAlternates('court-document-translation') },
};
